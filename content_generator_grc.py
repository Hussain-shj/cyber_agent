...
3) لكل موضوع، اكتب محتوى عربي احترافي رسمي (أسلوب مؤسسي) خالٍ من الحشو وفق
   ...
   تحذير مهم: **لا تصف بطاقات/لوحات UI "تعرض" أو "تُصنِّف" مفاهيم بأسمائها**
   (مثل "بطاقات تعرض: كذا وكذا وكذا")، لأن هذا النوع من الوصف يُغري نموذج
   توليد الصور بكتابة تلك الأسماء كنص فعلي داخل الصورة رغم منعه صراحة —
   بدلاً من ذلك، صف المشهد بصرياً بحتاً (أشخاص، أجهزة، مستندات، أماكن) بلا أي
   إشارة لكتابة أو تصنيف أو تسمية أي شيء داخل الصورة.
4) أعد الصياغة دائماً؛ لا تنسخ نصوصاً حرفية من المصادر.
