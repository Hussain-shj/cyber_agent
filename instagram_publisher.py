...
def _source_line(draw, source: str):
    ...
    w = _measure_mixed_line(draw, text, 26)
    x = WIDTH - w - 50
    y = HEIGHT - 60
    draw.rounded_rectangle([x - 16, y - 8, x + w + 16, y + 34], radius=10, fill=(6, 9, 14))
    _draw_mixed_line(draw, text, 26, COLORS["cyan"], x, y)
...
def design_alert(title: str, tag: str, details: str = "", date_str: str = "", source: str = "") -> Image.Image:
