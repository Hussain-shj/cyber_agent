...
3) اكتب محتوى عربي احترافي مختصر خالٍ من الحشو. مهم: ميّز دائماً بين نص
   ...
   بالإضافة لذلك، صمّم مفهوماً بصرياً واحداً (visual_concept) خاصاً بهذا
...

{
  ...
  "visual_concept": "وصف بالإنجليزية (جملة واحدة، 15-25 كلمة) لعنصر بصري تجريدي واحد محدد يمثّل جوهر هذا الخبر تحديداً (وليس التصنيف العام) — سيُستخدم كبرومبت لنموذج توليد صور لرسم خلفية فنية. مثال جيد: 'A network firewall device cracking apart with red digital tendrils spreading across its surface, representing a ransomware breach'. اذكر نوع الجهاز/التقنية المتأثرة تحديداً إن كان معروفاً (جدار حماية، خادم، هاتف، متصفح...). ممنوع تماماً: أي إشارة لأشخاص أو وجوه أو نصوص أو شعارات داخل الوصف — عنصر تجريدي/رمزي فقط",
